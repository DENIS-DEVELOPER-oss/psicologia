...
export default async function NewsDetailPage() {
  ...
  if (!newsItem) {
    ...
    // You could redirect to a 404 page or show a message
     return (
       <div className="container px-4 md:px-6 py-16 md:py-24 lg:py-32 text-center"> {/* Added px-4 md:px-6 */}
  ...
  return (
    <div className="container px-4 md:px-6 py-16 md:py-24 lg:py-32 max-w-4xl mx-auto"> {/* Added px-4 md:px-6 and max-width centering */}
